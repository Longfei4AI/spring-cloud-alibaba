...
import com.altomni.apn.common.config.JHipsterConstants;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.altomni.apn.authority.exception.EmailAlreadyUsedException ex,
        NativeWebRequest request
    ) {
        com.altomni.apn.authority.exception.EmailAlreadyUsedException problem = new EmailAlreadyUsedException();
        return create(
            problem,
            request,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        com.altomni.apn.authority.exception.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.altomni.apn.authority.exception.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.altomni.apn");
    }
}
