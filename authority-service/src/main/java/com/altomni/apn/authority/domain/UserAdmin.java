...
public class UserAdmin extends AbstractAuditingEntity implements UserSecurityInterface,Serializable {
    ...
    @ManyToMany
    @JoinTable(
        name = "user_admin_authority",
        joinColumns = { @JoinColumn(name = "user_admin_id", referencedColumnName = "id") },
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserAdmin)) {
            return false;
        }
        return id != null && id.equals(((UserAdmin) o).id);
    }
